...
class Pdf extends FPDF {
	...
	public function header(){
		$this->Ln(16);
		$this->Image(site_url('assets/img/laporan.png'),10,5,-250);//site_url('assets/img/laporan.png')
		$this->Ln(1);
...
class Pdf_tepe extends FPDF {
	...
	public function header(){
        ...
        $this->Ln(1);
        $this->SetFont('Arial','B',11);
		$this->Cell(0,7,'DAFTAR TRAINING PROGRAM PT GHITA AVIA TRANS (GATRANS)',0,1,'C');
		$this->Ln(1);
        $this->SetFont('Arial','B',9);
		$this->SetFillColor(178,34,34);
		$this->SetTextColor(255,255,255);
		$this->SetDrawColor(47,79,79);
        $this->Cell(7,7,'No',1,0,'C',true);
        $this->Cell(44,7,'Nama Peserta',1,0,'C',true);
		$this->Cell(15,7,'NIK',1,0,'C',true);
		$this->Cell(50,7,'Jabatan',1,0,'C',true);
		$this->Cell(85,7,'Training',1,0,'C',true);
		$this->Cell(44,7,'Tempat Training',1,0,'C',true);
		$this->Cell(16,7,'Tgl Ikut',1,0,'C',true);
		$this->Cell(16,7,'Tgl Akhir',1,1,'C',true);
		$this->Ln(1);
	}
