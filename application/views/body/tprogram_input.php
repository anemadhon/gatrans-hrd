<div class="container-fluid">
			<div class="row">
				...
				<div id="content-bar">
					...
					<div id="content-side">
						...
						<?php
						echo form_open_multipart('input-tp','autocomplete="off"');
							...
							<div class="col s12 m8 l9">
								<div class="row">
							        <div class="col s12 input-field">
							        	<input type="text" class="browser-default text-input text-box-input autocomplete" id="namaPeserta" name="namapeserta" placeholder="Cari Nama Peserta">
								...
								<div class="row">
							        <div class="col s12">
							        	<input type="text" class="browser-default text-input text-box-input" id="tmptTraining" name="tmpttraining" placeholder="Tempat Training / Pemateri (Kantor Pemateri)">
							        </div>
								</div>
                                <div class="row space-box">
							        <div class="col s6 space">
        ...
        <script>
            $(document).ready(function(){
                $.post("<?php echo site_url('ajax-tepe'); ?>", (res) => {
                ...
                $('input.autocomplete').on('change', function(){
                    $.ajax({
                        type:"post",
                        url:"<?php echo site_url('ajax-tepe-auto-complete'); ?>",
                        data:{nama:$(this).val()},
                        success:function(res){
                            const data = JSON.parse(res);
                            if (data) {
                                $('#idPeserta').val(data.data.id)
