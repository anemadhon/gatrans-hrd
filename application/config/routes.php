...
$route['tp'] = 'hrd/tepe';
$route['ajax-tepe'] = 'hrd/ajax_tepe';
$route['ajax-tepe-auto-complete'] = 'hrd/ajax_tepe_auto_complete';
$route['input-tp'] = 'input/tepe_submit';
$route['data-tp/display'] = 'tepe/display';
$route['caridata-tp'] = 'hrd/caritepe';
$route['pdf-tp'] = 'cetak/pdf_tepe';
$route['excel-tp'] = 'cetak/excel_tepe';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
